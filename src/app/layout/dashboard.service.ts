...
export class DashboardService {
   ...
   public getProfileByUserID(user_id: String):Observable<any>{
    ...
    // public getBusinessManById(id:string):Observable<any>{
    //     //Todo: update amazon server code and mongoDb , add businessManFullDetails?id api
    //     return this.http.get(this.config.apiEndpoint+'/businessManDetails?id='+id);     
    // }
